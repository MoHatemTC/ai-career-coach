...
class ApplicationRequest(BaseModel):
    ...
    """
    candidate_id: int = Field(..., description="Unique identifier of the candidate")
    ...
    job_description: Optional[str] = Field(None, description="Full text of the target job description. If not provided, it will be resolved from the database using job_id.")
